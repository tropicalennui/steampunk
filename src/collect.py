...
# ---------------------------------------------------------------------------
# Xbox Live — fetch (async, bridged to sync via asyncio.run)
# ---------------------------------------------------------------------------
...
async def _xbox_fetch_async(
    ...
    async with SignedSession() as session:
        ...
        # replacement method that replicates the provider's exact HTTP call —
        # preserving auth headers and SignedSession — but sanitises nulls first.
        import types
...
# ---------------------------------------------------------------------------
# Xbox Live — promote staging → canonical
# ---------------------------------------------------------------------------
